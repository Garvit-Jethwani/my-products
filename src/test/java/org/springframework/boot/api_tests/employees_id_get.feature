...
Scenario: Verify employee response contains expected fields
  Given path '/employees/d290f1ee-6c54-4b01-90e6-d701748f0851'
  And header Authorization = 'Bearer ' + authToken
  When method GET
  Then status 200 
  And match response contains {"jobTitle":"System Analyst", "name":"John Smith", "email":"john.smith@acme-corp.com"}

Scenario: Get a non-existent employee
