...
# Test generated by RoostGPT for test ProductOrde-Karate-productOrder-api using AI Type Claude AI and AI Model claude-3-5-sonnet-20240620
# 
...
Feature: State Change Event By Client
  ...
  Scenario Outline: State Change Event By Client - <scenario>
  ...
  Scenario: State Change Event By Client - Bad Request
    Given path '/listener/productOrderStateChangeEvent'
    And header Authorization = 'Bearer ' + authToken
    And request {}
    When method POST
  ...
  Scenario: State Change Event By Client - Unauthorized
    Given path '/listener/productOrderStateChangeEvent'
    And request {}
    When method POST
    Then status 401

  Scenario: State Change Event By Client - Server Error
    Given path '/listener/productOrderStateChangeEvent'
    And header Authorization = 'Bearer ' + authToken
    And request {}
    When method POST
  ...
  Scenario: State Change Event By Client - Service Unavailable
    Given path '/listener/productOrderStateChangeEvent'
    And header Authorization = 'Bearer ' + authToken
    And request {}
    When method POST
  ...
  Scenario: State Change Event By Client - Timeout
    Given path '/listener/productOrderStateChangeEvent'
    And header Authorization = 'Bearer ' + authToken
    And request {}
    When method POST
    Then status 504
    * def closingNotification =
      """
      {
        "notification": {
    ...
    * def ontAlreadyInUse =
      ...
      """
    * def closingNotificationOntOwner =
      """
      {
        "notification": {
